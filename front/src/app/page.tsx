  ...
  return (
    <div className="min-h-screen bg-[#eef4fb] text-slate-900">
      <div className="mx-auto flex min-h-screen w-full max-w-7xl flex-col px-4 py-4 sm:px-6 lg:px-8">
        <header className="flex flex-col gap-4 rounded-[30px] border border-white/80 bg-white/80 px-6 py-5 shadow-[0_18px_45px_-32px_rgba(76,111,171,0.5)] backdrop-blur sm:flex-row sm:items-center sm:justify-between">
          <Link href="/" className="flex items-center gap-3">
            <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-[#78a7e6] text-lg font-semibold text-white shadow-[0_12px_24px_-12px_rgba(55,108,188,0.8)]">
              온
            </div>
            <div>
          ...
          <nav className="flex flex-wrap items-center gap-x-5 gap-y-2 text-sm font-medium text-slate-600">
            ...
            <Link
              href="/login"
              className="rounded-full border border-[#bed3f4] bg-[#f6f9ff] px-4 py-2 text-slate-700 transition hover:border-[#78a7e6] hover:text-slate-900"
            >
              로그인
            </Link>
          </nav>
        ...
        <main className="mt-4 flex flex-1 flex-col gap-4">
          <section className="overflow-hidden rounded-[38px] bg-[#78a7e6] px-6 py-10 text-white shadow-[0_26px_70px_-34px_rgba(58,109,182,0.8)] sm:px-10 lg:px-14 lg:py-14">
          ...
          <section className="grid gap-4 xl:grid-cols-[minmax(0,1.85fr)_320px]">
            <section
              id="stories"
              className="rounded-[32px] border border-white/80 bg-white/80 p-6 shadow-[0_18px_48px_-32px_rgba(73,105,160,0.45)] backdrop-blur sm:p-8"
            >
              ...
              <div className="mt-6 grid gap-4 sm:grid-cols-2 xl:grid-cols-3">
                {storyShellItems.map((item) => (
                  <article
                    ...
                    className="rounded-[24px] border border-[#bfd2f0] bg-[#fdfefe] px-5 py-4 shadow-[0_18px_40px_-34px_rgba(74,112,173,0.45)]"
                  >
                    <p className="text-sm font-medium text-[#5e83c1]">
                      [{item.category}]
                    </p>
            ...
            <aside className="flex flex-col gap-4">
              <section className="rounded-[30px] border border-white/80 bg-white/85 p-6 shadow-[0_18px_48px_-32px_rgba(73,105,160,0.45)] backdrop-blur">
                <h2 className="text-2xl font-semibold tracking-[-0.03em] text-slate-900">
                  비밀 편지
                </h2>
                <div className="mt-4 rounded-[24px] border border-[#bfd2f0] bg-[#f8fbff] p-5">
                  ...
                  <Link
                    href="/letters/write"
                    className="mt-5 inline-flex rounded-full bg-[#78a7e6] px-4 py-2 text-sm font-medium text-white transition hover:bg-[#6898db]"
                  >
                    편지 쓰기
                  </Link>
                </div>
              ...
              <section
                id="diary"
                className="rounded-[30px] border border-white/80 bg-white/85 p-6 shadow-[0_18px_48px_-32px_rgba(73,105,160,0.45)] backdrop-blur"
              >
                <h2 className="text-2xl font-semibold tracking-[-0.03em] text-slate-900">
                  나의 일기
                </h2>
                <div className="mt-4 flex min-h-40 items-center justify-between gap-4 rounded-[24px] border border-[#bfd2f0] bg-[#f8fbff] p-5">
        ...
        <footer className="mt-4 rounded-[28px] bg-[#78a7e6] px-6 py-4 text-sm text-white/90 shadow-[0_18px_40px_-30px_rgba(58,109,182,0.8)]">
